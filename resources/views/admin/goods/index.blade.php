                ...
                <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-hover" id="treeTable">
                            ...
                            <tr id="{{ $item->id }}">
                                <td>
                                    @if(!empty($item->gImg[0]->imgUrl))
                                        <img src="{{ $item->gImg[0]->imgUrl }}" alt="" width="50">
                                    @endif
                                    {{ $item->gName}}
                                </td>
                                <td>{{ $item->cName }}</td>
                                ...
                                <td>
                                    ...
                                    <a href='javascript:;' data-id='1' class='btn btn-danger btn-xs destroy'>
                                        ...
                                        <form action='/admin/goods/del/{{ $item->id }}' method='get'  name='delete_item_1'  style='display:none'>
